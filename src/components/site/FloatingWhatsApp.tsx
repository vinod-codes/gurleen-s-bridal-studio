...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-wine text-ivory shadow-[0_10px_30px_-10px_rgba(122,31,43,0.6)] border border-gold/40 transition-transform group-hover:scale-105">
