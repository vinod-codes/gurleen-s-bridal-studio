    ...
    <footer className="bg-white text-black border-t border-black/10">
      ...
      <div className="border-b border-black/10">
        <div className="mx-auto max-w-screen-2xl px-6 md:px-10 py-4 flex flex-wrap items-center justify-between gap-3 font-sans text-[11px] font-medium tracking-[0.2em] uppercase text-gray-500">
          <span>Gurleen Kaur Pannu Artistry & Makeovers</span>
      ...
      <div className="mx-auto max-w-screen-2xl px-6 md:px-10 py-16 md:py-24 grid md:grid-cols-4 gap-12 md:gap-8">
        ...
        <div>
          ...
          <ul className="space-y-4 font-display text-[16px] uppercase tracking-wide">
            <li><Link to="/bridal" className="hover:text-gray-500 transition-colors">Bridal</Link></li>
            <li><Link to="/destination-weddings" className="hover:text-gray-500 transition-colors">Destination</Link></li>
            <li><Link to="/engagement-reception" className="hover:text-gray-500 transition-colors">Engagement</Link></li>
            <li><Link to="/academy" className="hover:text-gray-500 transition-colors">Academy</Link></li>
            <li><Link to="/pricing" className="hover:text-gray-500 transition-colors">Pricing</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 font-display text-[16px] uppercase tracking-wide">
            <li><Link to="/portfolio" className="hover:text-gray-500 transition-colors">Portfolio</Link></li>
            <li><Link to="/about" className="hover:text-gray-500 transition-colors">About</Link></li>
            <li><Link to="/testimonials" className="hover:text-gray-500 transition-colors">Testimonials</Link></li>
            <li><Link to="/faq" className="hover:text-gray-500 transition-colors">FAQ</Link></li>
        ...
        <div className="bg-black text-white p-8 md:p-10">
          <p className="font-sans text-[11px] font-medium tracking-[0.25em] uppercase mb-6 text-white/70">04 / Signal</p>
          ...
          >
            <div className="flex items-center border-b border-white/30 focus-within:border-white transition-colors pb-2">
              <input
                name="email"
                type="email"
                required
              ...
              <button
                type="submit"
                className="font-sans text-[11px] font-medium tracking-[0.25em] uppercase px-3 py-2 -mr-2 text-white/70 hover:text-white transition-colors"
              >
                Send
              </button>
            </div>
          ...
          <ul className="mt-10 space-y-3 font-sans text-[11px] tracking-[0.2em] uppercase text-white/70">
            <li><a href={WA.general} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">WhatsApp</a></li>
            <li><a href={`tel:${PHONE}`} className="hover:text-white transition-colors">{PHONE_DISPLAY}</a></li>
            <li><a href={IG_BUSINESS} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">@gurleenkaurpannu_mua</a></li>
            <li><a href={IG_PERSONAL} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">@gurleenkaurpannnu</a></li>
            <li><a href={THREADS} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Threads</a></li>
          </ul>
        </div>
      </div>
