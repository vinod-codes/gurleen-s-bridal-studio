...
## Corpus Check
- 111 files · ~31,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 630 nodes · 1012 edges · 55 communities (43 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1e66879`
...
- **Why does `react` connect `react` to `Frontend Dependencies`, `alert-dialog.tsx`?**
